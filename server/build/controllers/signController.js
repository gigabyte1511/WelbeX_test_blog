...
var signUp = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1, createUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, authValidator.signUpSchema.validate(req.body, { abortEarly: false })];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                ...
                res
                    .status(400)
                    .json((0, utils_1.getPreparedErrorsFromYup)(error_1));
                return [2 /*return*/];
            case 3:
                _a.trys.push([3, 7, , 8]);
                return [4 /*yield*/, authService.checkEmailUnique(req.body.email)];
            case 4:
                if (!_a.sent()) return [3 /*break*/, 6];
                return [4 /*yield*/, authService.createUser(req.body)];
            case 5:
                createUser = _a.sent();
                res
                    .status(200)
...
var signIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error_3, authenticatedUser, error_4, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, authValidator.signInSchema.validate(req.body, { abortEarly: false })];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
var signOut = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, authService.signOut(req.userID)];
            case 1:
                _a.sent();
                res.sendStatus(200);
                return [3 /*break*/, 3];
